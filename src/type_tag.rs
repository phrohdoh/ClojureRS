...
impl fmt::Display for TypeTag {
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let str = match self {
            ...
            List => std::string::String::from("clojure.lang.PersistentList"),
            Vector => std::string::String::from("clojure.lang.PersistentVector"),
            Map => std::string::String::from("clojure.lang.PersistentMap"),
